                ...
                <div className="header-logged">
                    <div className="header-limit">
                        { loading ? 
                            ...
                            <><div className="limit-used">Использовано компаний: 
                                <span>{user.usedCompanyCount}</span></div>
                            <div className="limit-available">Лимит по компаниям: 
                                <span>{user.companyLimit}</span></div></>
                        }
                    </div>
                    { !isMobile ? 
